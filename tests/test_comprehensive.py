"""Comprehensive test suite for OpenGov-Grants."""
...
from opengovgrants.core.config import Settings, get_settings
from opengovgrants.core.database import DatabaseManager
from opengovgrants.services.agent_service import AgentService
from opengovgrants.storage.item_storage import ItemStorage
...
class TestSettings:
    ...
    def test_environment_variable_override(self, monkeypatch):
        ...
        monkeypatch.setenv("OPENGRANTS_DEBUG", "true")
        settings = Settings()
...
class TestFastAPIEndpoints:
    ...
    def test_fastapi_app_creation(self):
        ...
        assert app.title == "OpenGov-Grants API"
    ...
    def test_root_endpoint(self, client):
        ...
        data = response.json()
        assert data["name"] == "OpenGov-Grants"
    ...
    def test_health_endpoint(self, client):
        ...
        assert data["service"] == "OpenGov-Grants"
...
class TestCLICommands:
    ...
    def test_version_command(self, cli_runner):
        ...
        from opengovgrants.cli import app
        result = cli_runner.invoke(app, ["--version"])
        assert result.exit_code == 0
        assert "OpenGov-Grants v1.0.0" in result.output
    ...
    def test_help_command(self, cli_runner):
        ...
        assert result.exit_code == 0
        assert "OpenGov-Grants" in result.output
